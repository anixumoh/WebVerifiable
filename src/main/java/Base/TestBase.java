...
public abstract class TestBase extends ExtentReport {
    ...
    public AddProviderPage addProviderPage;
    public AddEducationPage addEducationPage;
    public AddTrainingPage addTrainingPage;
    public AddWorkHistoryPage addWorkHistoryPage;
    public AddLiabilityInsurancePage addLiabilityInsurancePage;
    ...
    public void PageObject() {
        ...
        addProviderPage = new AddProviderPage();
        addEducationPage = new AddEducationPage();
        addTrainingPage = new AddTrainingPage();
        addWorkHistoryPage = new AddWorkHistoryPage();
        addLiabilityInsurancePage = new AddLiabilityInsurancePage();
    }
